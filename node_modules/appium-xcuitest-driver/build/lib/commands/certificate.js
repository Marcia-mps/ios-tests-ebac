...
exports.installCustomSslCertFromCapability = installCustomSslCertFromCapability;
 ...
 */
async function installCustomSslCertFromCapability() {
    const pem = this.opts.customSSLCert;
    if (!pem) {
        return;
    }
    (0, utils_1.requireRealDevice)(this, 'install customSSLCert capability');
    await withCertificateClient(this, async (client) => {
