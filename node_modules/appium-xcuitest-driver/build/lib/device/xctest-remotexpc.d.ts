 ...
 */
export declare function runXCTestViaRemoteXPC(udid: string, testRunnerBundleId: string, appUnderTestBundleId: string, xctestBundleId: string, testType?: 'app' | 'ui' | 'logic', args?: string[], env?: StringRecord, timeout?: number): Promise<RunXCTestResult>;
/**
 ...
 */
export declare function listXCTestBundlesViaRemoteXPC(udid: string): Promise<string[]>;
/**
 * Install an XCTest bundle via RemoteXPC.
 * Only supports .ipa and .app bundles (not bare .xctest directories).
 */
export declare function installXCTestBundleViaRemoteXPC(udid: string, xctestApp: string): Promise<void>;
//# sourceMappingURL=xctest-remotexpc.d.ts.map