...
const networkMonitorCommands = __importStar(require("./commands/network-monitor"));
...
class XCUITestDriver extends driver_1.BaseDriver {
    ...
    async deleteSession(sessionId) {
        ...
        for (const recorder of lodash_1.default.compact([this._recentScreenRecorder, this._audioRecorder])) {
